...
<div class="head_container">
	<div class="head_welcome">
		...
		<s:if test="#session.user.username != null"><%-- ${sessionScope.user.username} --%>
		<b>您好<s:property value="#session.user.username" />，欢迎光临当当网</b>
		[&nbsp;<a href="${pageContext.request.contextPath }/exitAction" class="b">登出</a>&nbsp;]
		</s:if>
		<s:else>
