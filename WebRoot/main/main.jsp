	...
	<body>
		...
		<div class="book">
			...
			<div id="left" class="book_left">
				<s:action name="categoryAction" executeResult="true"></s:action>
			</div>
			<!--左栏结束-->
			...
			<div class="book_center">
				...
				<s:action name="recommendAction" executeResult="true"></s:action>
				</div>
				...
				<s:action name="hotAction" executeResult="true"></s:action>
				</div>
				<!--热销图书结束-->

				<!--最新上架图书开始-->
				<div class="book_c_border2" id="new">
				<s:action name="newAction" executeResult="true"></s:action>
				</div>
			...
			<div class="book_right">
				<div class="book_r_border2" id="__XinShuReMai">
					<div class="book_r_b2_1x" id="new_bang">
						<s:action name="hotbAction" executeResult="true"></s:action>
					</div>
				</div>
			</div>
			<!--右栏结束-->
