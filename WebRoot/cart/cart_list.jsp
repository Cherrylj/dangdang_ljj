					...
					<tr class='objhide' over="no">
                      ...
                      <s:iterator value="#session.map">
						<tr class='td_no_bord'>
							...
							<td>
								<a href="#"><s:property value="value.book.pname"/></a>
							</td>
							<td class="buy_td_5">
								<span class="c_gray"><s:property value="value.book.pricing"/></span>
							</td>
							<td class="buy_td_4">
								&nbsp;&nbsp;
								<span>￥<s:property value="value.book.sellingPrice"/></span>
							</td>
							<td class="buy_td_1">
							...
							<td >
								<input class="del_num" type="text" size="3" maxlength="4" id="<s:property value="value.book.id"/>" value="1" onblur="change()"/>
								<a href="javascript:"  onclick="location='changeAction.action?id=<s:property value="value.book.id"/>&count='+document.getElementById('<s:property value="value.book.id"/>').value">变更</a>
							</td>

							<td>
								<a href="${pageContext.request.contextPath }/delAction.action?id=<s:property value="value.book.id"/>">删除</a>
							</td>
						</tr>
					</s:iterator>
					<!-- 购物列表结束 -->
				...
				<div class="choice_balance">
					...
					<div class="total_balance">
						<div class="save_total">
							您共节省：
							<span class="c_red"> ￥<span id="total_economy"><s:property value="#session.save"/></span>
							</span>
							...
							<span class="c_red_b"> ￥<span id='total_account'><s:property value="#session.totalprice"/></span>
							</span>
						</div>
						<div id="balance" class="balance">
							<a name='checkout' href='${pageContext.request.contextPath }/order/order_info.jsp' > 
	 ...
	 -->	
		...
		<div id="divCartItemsRemoved" class="del_merch">
			...
			<table class=tabl_del id=del_table>
				<tbody>
				<s:iterator value="#session.delmap">
					...
					<tr>
						...
						<td width="106" class=buy_td_5>
							￥<s:property value="value.book.pricing"/>
						</td>
						<td width="134" class=buy_td_4>
							<span>￥<s:property value="value.book.sellingPrice"/></span>
						</td>
						<td width="56" class=buy_td_1>
							<a href="${pageContext.request.contextPath }/recoverAction.action?id=<s:property value="value.book.id"/>">恢复</a>
						</td>
